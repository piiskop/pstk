...
START TRANSACTION;
USE `kalad`;
INSERT INTO `kalad`.`kala` (`id_kala`, `nimetus`, `Ladinakeelne`, `sugukond_id_sugukond`) VALUES (1, 'Siig', 'Coregonus lavaretus lavaretus L.', NULL);
INSERT INTO `kalad`.`kala` (`id_kala`, `nimetus`, `Ladinakeelne`, `sugukond_id_sugukond`) VALUES (2, 'Ahven', 'Perca fluviatilis', NULL);
INSERT INTO `kalad`.`kala` (`id_kala`, `nimetus`, `Ladinakeelne`, `sugukond_id_sugukond`) VALUES (3, 'Särg', 'Rutilus rutilus', NULL);
INSERT INTO `kalad`.`kala` (`id_kala`, `nimetus`, `Ladinakeelne`, `sugukond_id_sugukond`) VALUES (4, 'Haug', 'Esox lucius', NULL);
INSERT INTO `kalad`.`kala` (`id_kala`, `nimetus`, `Ladinakeelne`, `sugukond_id_sugukond`) VALUES (5, 'Räim', 'Clupea harengus membras', NULL);
INSERT INTO `kalad`.`kala` (`id_kala`, `nimetus`, `Ladinakeelne`, `sugukond_id_sugukond`) VALUES (6, 'Lõhe', 'Salmo salar', NULL);
...
START TRANSACTION;
USE `kalad`;
INSERT INTO `kalad`.`kala_has_elukoht` (`kala_id_kala`, `elukoht_id_elukoht`) VALUES (1, NULL);
INSERT INTO `kalad`.`kala_has_elukoht` (`kala_id_kala`, `elukoht_id_elukoht`) VALUES (2, NULL);
INSERT INTO `kalad`.`kala_has_elukoht` (`kala_id_kala`, `elukoht_id_elukoht`) VALUES (3, NULL);
INSERT INTO `kalad`.`kala_has_elukoht` (`kala_id_kala`, `elukoht_id_elukoht`) VALUES (1, NULL);
