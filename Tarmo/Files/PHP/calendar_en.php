  ...
  **/
  class Calendar {
    ...
    **/
    ...
    /********************* PROPERTY ********************/
    private $dayLabels = array("E", "T", "K", "N", "R", "L", "P");
    ...
    **/
    private function _createNavi() {
      ...
      return '<div class="calendar_header">' . "\r\n" . '<a class="calendar_prev" href="' . $this->naviHref . '?month=' . sprintf('%02d', $preMonth) . '&amp;year=' . $preYear.'">Eelmine</a>' . "\r\n" . '<span class="calendar_title">' . date('Y M', strtotime($this->currentYear . '-' . $this->currentMonth . '-1')) . '</span>' . "\r\n" . '<a class="calendar_next" href="' . $this->naviHref . '?month=' . sprintf("%02d", $nextMonth) . '&amp;year=' . $nextYear . '">Järgmine</a>' . "\r\n"  . '</div>';
    }
    /**
