...
class View
{
	 ...
	 *        	the designer
	 * @param string[int] $parameters['logos']
	 *        	the logos
	 * @param string[int] $parameters['menus']
	 *        	the menus
	 * @param string $parameters['phoneNumber']
	 *        	the phone number
	 * @param string[int] $parameters['services']
	 *        	the services
	 ...
	 * @uses \pstk\ErrorView for building the error message
		...
		$tpl->setVariable(
			array(
				...
				'STYLE' => \pstk\CssView::buildCss(array (
					'fileName' => 'from-design-to-web-template'
				)),
